...
ปรับคำสั่งระบบใน `supabase/functions/super-function/index.ts` ให้เป็นเพื่อนฝึกคิดภาษาไทย: อธิบายและยกตัวอย่างก่อน ถามทีละคำถาม ให้คำใบ้แทนเฉลย ลดความยากเมื่อไม่เข้าใจ และไม่ถามวนเมื่อจบบทสนทนา
ทดสอบ Gemini จริงแบบต่อเนื่องสามช่วง: ตรวจความมั่นใจของ AI → ขอคำอธิบายง่ายขึ้น → ขอบคุณและจบ พร้อมทดสอบเส้นทางบันทึกประวัติและแยกบัญชีด้วย `tests/chat-history-client.test.cjs`
กำหนด thinkingBudget 0 เฉพาะตระกูล Gemini 2.5 Flash และเพิ่มงบคำตอบแชทเป็น 1200 tokens เพื่อให้มีพื้นที่สำหรับภาษาไทย
อ้างอิง API: https://ai.google.dev/gemini-api/docs/generate-content/thinking
