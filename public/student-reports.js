(function(){
 ...
 window.openReportArchive=async function(teacher){
  ...
  panel.innerHTML='<div style="max-width:960px;margin:auto"><div style="position:sticky;top:0;z-index:2;background:#fffdf5;padding:8px 0 12px"><button class="btn whiteb sm" onclick="closeReportArchive()">← กลับเมนูครู</button></div><h2>📁 รายงานรายบุคคล</h2><p>ฉบับล่าสุดบันทึกอัตโนมัติ ส่วนฉบับที่ส่งครูเก็บย้อนหลังโดยไม่ทับกัน</p>'+select+'<p id="report-status" role="status" aria-live="polite"></p><div id="report-content"></div></div>';
